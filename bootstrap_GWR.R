...
# Define GWR formula (excluding multicollinear variable like 'total_local_tax')
...
# Run GWR model on original data
gwr_original <- gwr(
  gwr_formula,
...
# Extract coefficient variables (excluding intercept)
